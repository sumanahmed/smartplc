    ...
    try {
      if (editing && editing.id) {
        ...
        const updatedWithRelations: Product = {
          ...
          meta_title: (updated as any).meta_title ?? editing.meta_title,
          meta_keyword: (updated as any).meta_keyword ?? editing.meta_keyword,
          meta_description: (updated as any).meta_description ?? editing.meta_description,
        ...
        const createdWithRelations: Product = {
          ...
          meta_title: (created as any).meta_title,
          meta_keyword: (created as any).meta_keyword,
          meta_description: (created as any).meta_description,
